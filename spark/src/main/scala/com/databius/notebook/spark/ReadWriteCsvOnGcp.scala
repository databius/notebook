...
/*
implementation("com.google.cloud.bigdataoss:gcs-connector:hadoop3-2.1.5")
implementation("com.google.cloud.spark:spark-bigquery-with-dependencies_$scalaMajorVersion:0.17.2")
 */

object ReadWriteCsvOnGcp extends App {
  ...
  spark.sparkContext.hadoopConfiguration
    .set("google.cloud.auth.service.account.json.keyfile",
         sys.env("GOOGLE_APPLICATION_CREDENTIALS"))
  ...
  df.write
    ...
    .option("clusteredFields", "exch,sym")
    .option("temporaryGcsBucket", "ghpr-dev-dataflow-staging-us")
    .mode("overwrite")
    .save("ghpr-dev:ahab_test.csv")
}

...
object WindowedWordCount {
  private val WINDOW_SIZE = Duration.standardMinutes(1L)
          ...
          new Instant(
            ThreadLocalRandom
              ...
              .nextLong(
                ...
                System
                  .currentTimeMillis() + Duration.standardHours(1).getMillis))
        }
      }
    val wordCounts = x
